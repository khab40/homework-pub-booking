...
server. Session `sess_e469b341a4ee` completed through localhost Rasa 3.16.4 and
...
- Observed real run: `logs/examples/ex6-rasa-half/sess_e469b341a4ee`, booking reference `BK-7D401E9E`.
- Trace: `logs/examples/ex6-rasa-half/sess_e469b341a4ee/logs/trace.jsonl`, `structured.session_started` and `structured.completed`.
- Final state: `logs/examples/ex6-rasa-half/sess_e469b341a4ee/session.json`, `state: completed`.
